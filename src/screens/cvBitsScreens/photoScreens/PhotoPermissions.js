...
const PhotoPermissions = ({ bit }) => {
        ...
        <View style={styles.noPermissionsContainer}>
          ...
          {Platform.OS === 'ios' ? (
            <>
              ...
              <Text style={styles.noPermissionsText}>
                Search for 'CV Cloud' and tap on it
              </Text>
            ...
            <>
              ...
              <Text style={styles.noPermissionsStep}>Step 2</Text>
              <Text style={styles.noPermissionsText}>
                Search for 'Apps & notifications' and tap it
              </Text>
              <Text style={styles.noPermissionsStep}>Step 3</Text>
              <Text style={styles.noPermissionsText}>
                Find 'CV Cloud' and tap on it
              </Text>
              <Text style={styles.noPermissionsStep}>Step 4</Text>
      ...
      <View style={styles.noPermissionsBed}>
        <View style={styles.noPermissionsContainer}>
          <FontAwesome
            ...
            name="exclamation-triangle"
          />
          <Text style={styles.noPermissionsHeading}>Gallery access denied</Text>
          <Text style={styles.noPermissionsSubHeading}>To fix this:</Text>
          {Platform.OS === 'ios' ? (
            <>
              <Text style={styles.noPermissionsStep}>Step 1</Text>
              ...
              <Text style={styles.noPermissionsStep}>Step 2</Text>
              <Text style={styles.noPermissionsText}>
                Search for 'CV Cloud' and select it
              </Text>
              <Text style={styles.noPermissionsStep}>Step 3</Text>
              <Text style={styles.noPermissionsText}>Select 'Photos'</Text>
              <Text style={styles.noPermissionsStep}>Step 4</Text>
              <Text style={styles.noPermissionsText}>Select 'All Photos'</Text>
              <Text style={styles.noPermissionsStep}>Step 5</Text>
              <Text style={styles.noPermissionsText}>Return to CV Cloud</Text>
            </>
          ) : (
            <>
              ...
              <Text style={styles.noPermissionsStep}>Step 4</Text>
              <Text style={styles.noPermissionsText}>Select 'Permissions'</Text>
              <Text style={styles.noPermissionsStep}>Step 5</Text>
              <Text style={styles.noPermissionsText}>
                Select 'Files & media permissions' and enable 'Allow management
                of all files'
              </Text>
              <Text style={styles.noPermissionsStep}>Step 6</Text>
              <Text style={styles.noPermissionsText}>Return to CV Cloud</Text>
  ...
  const renderContent = () => {
    if (bit === 'camera') return noCameraPermissions()
    if (bit === 'gallery') return noGalleryPermissions()
    return null
  }
