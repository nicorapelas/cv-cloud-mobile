...
import VideoPlaybackUpload from '../../../components/video/VideoPlaybackUpload'
...
import VideoSample from '../../../components/video/VideoSample'

const FirstImpressionCreateScreen = ({ navigation }) => {
  ...
  const cameraPermissionsRequest = () =>
    (async () => {
      const { status } = await Camera.requestCameraPermissionsAsync()
      setCameraPermission(status === 'granted')
    })()

  const audioPermissionsRequest = () =>
    (async () => {
...
FirstImpressionCreateScreen.navigationOptions = ({ navigation }) => {
  return {
    headerTitleAlign: 'center',
    headerStyle: { backgroundColor: '#278ACD' },
    title: <Text style={styles.heading}>record first impression</Text>,
    headerLeft: () => <HeaderBackButtonLink routeName="FirstImpression" />,
  }
}
